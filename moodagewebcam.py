...
# MediaPipe için hazırla
mp_drawing = mp.solutions.drawing_utils
mp_hands = mp.solutions.hands
mp_face_mesh = mp.solutions.face_mesh

# Yüz ve el algılayıcıları
...
while cap.isOpened():
    ...
    # El noktalarını ve çubuklarını çiz
    ...
    if results_face.multi_face_landmarks:
        for face_landmarks in results_face.multi_face_landmarks:
            ...
            # Mood ve Age tahminlerini ekrana yaz
            # Basit tahminler (örnek)
            mood = ""  # Burada bir model ile gerçek tahmin yapılabilir
            age = ""      # Burada bir model ile gerçek tahmin yapılabilir
    ...
    if cv2.waitKey(5) & 0xFF == 27:  # ESC tuşuna basarak çıkabilirsiniz
        break
